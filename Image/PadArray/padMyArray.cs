...
namespace Image
{
    public class PadMyArray <T>
    {
        ...
        {
            return PadArrayByNumProcess(arr, padR, padC, num, direction);
        }

        private T[,] PadArrayByNumProcess(T[,] arr, int padR, int padC, int num, Direction direction)
        {
        ...
        public T[,] PadArray(T[,] arr, int padR, int padC, PadType padType, Direction direction)
        {
            return PadArrayProcess(arr, padR, padC, padType, direction);
        }

        //BDSM array padding function
        private T[,] PadArrayProcess(T[,] arr, int padR, int padC, PadType padType, Direction direct) 
        {
